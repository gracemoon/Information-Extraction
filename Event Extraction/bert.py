    ...
    for epoch in range(0,epochs):
        ...
        for step,batch in enumerate(train_loader):
            ...
            if(step%50==0):
                ...
                print("the train accuracy:"+str(train_accuracy))
        ...
        for step,batch in enumerate(test_loader):
            ...
            with torch.no_grad():
                ...
                step_accuracy=accuracy(test_labels.detach().numpy(),logit.detach().cpu().numpy())
                eval_accuracy+=step_accuracy
                eval_step=eval_step+1
        eval_accuracy/=eval_step
        print("the validation accuracy:"+str(eval_accuracy))
